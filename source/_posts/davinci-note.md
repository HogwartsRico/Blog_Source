...
在拖动位置等参数的时候，数字变化很快，此时如果按住alt再拖动，会变得丝滑一些。 

或者更加直观一点,点击下方红框内的按钮，进行调整 可以缩放和旋转 
...
如上图所示，这些参数右侧都有菱形，当时间轴的帧卡尺走到某个地方的时候，改变数值，打一个关键帧，走到另外一个地方的时候，改变数值，打一个关键帧，就会产生变化



如果后续想调整关键帧的时间，以及想在时间轴上看到关键帧，怎么办呢？ 如下图所示
